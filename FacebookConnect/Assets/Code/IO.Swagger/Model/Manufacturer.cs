...
namespace IO.Swagger.Model
{
        ...
        public partial class Manufacturer :  IEquatable<Manufacturer>, IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public Manufacturer(string  = default(string), string  = default(string), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for Manufacturer and cannot be null");
            }
            else
            {
                this.Name = ;
